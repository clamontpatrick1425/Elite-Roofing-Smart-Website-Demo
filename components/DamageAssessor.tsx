...
interface DamageAssessorProps {
  onScheduleClick: () => void;
}

const DamageAssessor: React.FC<DamageAssessorProps> = ({ onScheduleClick }) => {
            ...
            <div className="max-w-3xl mx-auto bg-gray-50 p-8 rounded-2xl shadow-xl border border-gray-200">
                {!mediaPreview ? (
                    <div className="flex flex-col items-center justify-center">
                        <label htmlFor="roof-media-upload" title="Upload a photo or video of your roof" className="w-full flex flex-col items-center px-6 py-10 bg-white text-blue-600 rounded-lg shadow-md border border-blue-200 cursor-pointer hover:bg-blue-50 hover:text-blue-700 transition-colors">
                             ...
                             {analysis && !loading && (
                                 <>
                                    ...
                                    <div className="mt-6 text-center">
                                        ...
                                        <button onClick={onScheduleClick} className="mt-2 inline-block bg-green-600 text-white font-bold py-2 px-6 rounded-lg shadow-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105">
