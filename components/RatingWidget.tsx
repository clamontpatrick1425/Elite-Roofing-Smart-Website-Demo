...
import { FacebookIcon, YelpIcon } from './Icon';
...
const RatingWidget: React.FC<RatingWidgetProps> = ({ onClick }) => {
    return (
        <button 
            onClick={onClick}
            className="fixed bottom-8 left-8 z-40 bg-gray-900 dark:bg-gray-800 text-white p-4 rounded-2xl shadow-2xl flex flex-col items-center gap-2 border border-white/10 transition-all group transform scale-[1.35] origin-bottom-left hover:scale-[1.4]"
