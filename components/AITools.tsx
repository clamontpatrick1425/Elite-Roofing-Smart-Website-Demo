...
const AITools: React.FC<AIToolsProps> = ({ onEstimateClick, onDamageAssessorClick, onVisualizerClick, onVeoStudioClick }) => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Get instant insights, cinematic project animations, and roof health reports with zero guesswork.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
          ...
          <div className="group bg-gray-50 dark:bg-gray-800 p-8 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">AI Project Estimate</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-8 flex-grow leading-relaxed text-sm">Get a transparent, data-driven quote in under 60 seconds based on local material costs.</p>
            <button
          ...
          <div className="group bg-gray-50 dark:bg-gray-800 p-8 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Project Visualizer</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-8 flex-grow leading-relaxed text-sm">Generate realistic "Before vs After" comparisons to see how materials look on your home.</p>
            <button
          ...
          <div className="group bg-gray-50 dark:bg-gray-800 p-8 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">AI Damage Check</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-8 flex-grow leading-relaxed text-sm">Upload a photo of your current roof for an instant preliminary health and damage report.</p>
            <button
