      ...
      >
        <header className="p-6 border-b border-white/10 flex flex-col">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                ...
                <button className="flex-shrink-0 px-4 py-2 bg-white/5 rounded-full text-xs font-bold opacity-70 hover:opacity-100">Lake Ozark <span className="opacity-50 ml-1">4.8</span></button>
                <button className="flex-shrink-0 px-4 py-2 bg-white/5 rounded-full text-xs font-bold opacity-70 hover:opacity-100">Springfield <span className="opacity-50 ml-1">4.8</span></button>
            </div>
